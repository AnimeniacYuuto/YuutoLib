...
public abstract class GuiContainerAlt extends GuiScreen
{
    ...
    public GuiContainerAlt(Container p_i1072_1_)
    {
     ...
     */
    protected abstract void drawGuiContainerForegroundLayer(int mX, int mY);

    protected abstract void drawGuiContainerBackgroundLayer(float p_146976_1_, int mX, int mY);
